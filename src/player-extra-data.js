...
const FLAG=Symbol.for('gcp-player-extra-v3');
if(!WorldDatabase.prototype[FLAG]){
  ...
  WorldDatabase.prototype.ensurePlayers=async function(...args){
    ...
    const confirmed=applyRecentTransfers(players);this.dataMeta={...(this.dataMeta||{}),confirmedTransferOverrides:confirmed.length,confirmedTransfersThrough:'2026-08-18'};
    return players;
  }
}
