...
const players=[
 ...
 p('lw','Raphinha','Left Winger',88),p('rw','Lamine Yamal','Right Winger',93,{starterPriority:70,realLifeStarter:true}),p('rw2','Reserve RW','Right Winger',84),p('st','CF','Centre-Forward',86),p('st2','CF2','Centre-Forward',80)
];
...
assert.equal(map.RW,'rw','highest-OVR natural right winger must start at RW');
